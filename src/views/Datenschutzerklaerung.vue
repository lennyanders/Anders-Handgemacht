<template>
  <main class="main">
    ...
    <p>
      ...
      hat einen besonders hohen Stellenwert für die Geschäftsleitung der Anders
      Handgemacht. Eine Nutzung der Internetseiten der Anders Handgemacht ist
    ...
    <p>
      ...
      Übereinstimmung mit den für die Anders Handgemacht geltenden
    ...
    <p>
      Die Anders Handgemacht hat als für die Verarbeitung Verantwortlicher
    ...
    <p>
      Die Datenschutzerklärung der Anders Handgemacht beruht auf den
    ...
    <p>Anders Handgemacht</p>
    <p>Amberg 12</p>
    <p>51688 Wipperfürth</p>
    <p>Deutschland</p>
    <p>Tel.: 0151 / 27552346</p>
    <p>E-Mail: info@anders-handgemacht.de</p>
    <p>Website: https://anders-handgemacht.de/</p>

    <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
    <p>
      Die Internetseite der Anders Handgemacht erfasst mit jedem Aufruf der
    ...
    <p>
      ...
      Anders Handgemacht keine Rückschlüsse auf die betroffene Person. Diese
      ...
      erhobenen Daten und Informationen werden durch die Anders Handgemacht
    ...
    <p>
      Die Internetseite der Anders Handgemacht enthält aufgrund von gesetzlichen
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          Person die Löschung von personenbezogenen Daten, die bei der Anders
          Handgemacht gespeichert sind, veranlassen möchte, kann sie sich hierzu
          jederzeit an einen Mitarbeiter des für die Verarbeitung
          Verantwortlichen wenden. Der Mitarbeiter der Anders Handgemacht wird
          veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
        </p>

        <p>
          Wurden die personenbezogenen Daten von der Anders Handgemacht
          öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
          gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
          verpflichtet, so trifft die Anders Handgemacht unter Berücksichtigung
          ...
          soweit die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der
          Anders Handgemacht wird im Einzelfall das Notwendige veranlassen.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          bei der Anders Handgemacht gespeichert sind, verlangen möchte, kann
          sie sich hierzu jederzeit an einen Mitarbeiter des für die
          Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Anders
          Handgemacht wird die Einschränkung der Verarbeitung veranlassen.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          betroffene Person jederzeit an einen Mitarbeiter der Anders
          Handgemacht wenden.
        </p>
      </li>
      <li>
        ...
        <p>
          Die Anders Handgemacht verarbeitet die personenbezogenen Daten im
        ...
        <p>
          Verarbeitet die Anders Handgemacht personenbezogene Daten, um
          ...
          Widerspricht die betroffene Person gegenüber der Anders Handgemacht
          der Verarbeitung für Zwecke der Direktwerbung, so wird die Anders
          Handgemacht die personenbezogenen Daten nicht mehr für diese Zwecke
          verarbeiten.
        </p>
        ...
        <p>
          ...
          Verarbeitung personenbezogener Daten, die bei der Anders Handgemacht
        ...
        <p>
          ...
          Person direkt an jeden Mitarbeiter der Anders Handgemacht oder einen
      ...
      <li>
        ...
        <p>
          ...
          betroffenen Person, trifft die Anders Handgemacht angemessene
    ...
    <p>
      Betreibergesellschaft der Dienste von Instagram ist die Facebook Ireland
    ...
    <p>
      ...
      und https://www.instagram.com/&#8203;about/legal/privacy/ abgerufen
      werden.
    </p>
